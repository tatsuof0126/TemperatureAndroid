...
import com.tatsuo.temperature.db.Person
...
class TemperatureMainActivity : AppCompatActivity(), TemperatureListFragment.OnListFragmentInteractionListener, GraphFragment.OnFragmentInteractionListener, PeopleFragment.OnFragmentInteractionListener, ConfigFragment.OnFragmentInteractionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ConfigManager().loadShowAdsFlag()) {
            ...
            // 会社携帯：276EB5AF5B07A5B142631A70BEE353EE、ASUS：08F7DFA353E42A1A2C190B38622A90BD
            val adRequest = AdRequest.Builder().addTestDevice("276EB5AF5B07A5B142631A70BEE353EE").addTestDevice("08F7DFA353E42A1A2C190B38622A90BD").build()
            ...
            val interstitialAdRequest = AdRequest.Builder().addTestDevice("276EB5AF5B07A5B142631A70BEE353EE").addTestDevice("08F7DFA353E42A1A2C190B38622A90BD").build()
            ...
            mInterstitialAd.adListener = object : AdListener() {
                override fun onAdClosed() {
                    ...
                    mInterstitialAd.loadAd(AdRequest.Builder().addTestDevice("276EB5AF5B07A5B142631A70BEE353EE").addTestDevice("08F7DFA353E42A1A2C190B38622A90BD").build())
                }
