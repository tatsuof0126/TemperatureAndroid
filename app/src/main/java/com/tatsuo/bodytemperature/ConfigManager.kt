...
class ConfigManager {
    ...
    companion object {
        ...
        val KEY_USE_FAHRENHEIT_FLAG = "USE_FAHRENHEIT_FLAG"
        ...
        fun loadUseFahrenheitFlag(): Boolean {
            val preferences = PreferenceManager.getDefaultSharedPreferences(TemperatureApplication.instance)
            return preferences.getBoolean(KEY_USE_FAHRENHEIT_FLAG, true)
        }

        fun saveUseFahrenheitFlag(useFahrenheitFlag: Boolean) {
            val preferences = PreferenceManager.getDefaultSharedPreferences(TemperatureApplication.instance)
            val editor = preferences.edit()
            editor.putBoolean(KEY_USE_FAHRENHEIT_FLAG, useFahrenheitFlag)
            editor.apply()
        }
    }
